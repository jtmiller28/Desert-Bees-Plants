...
dat = cbind(sonoran_g_reproj, exact_extract(tc[[1]], sonoran_g_reproj, "mean", progress = FALSE)) # testing exact_extract as a function, supposed to take the mean of each extraction? 
